...
frLayerNum FlexDRWorker::initTrackCoords_getNonPref(frLayerNum lNum)
{
  ...
  frLayerNum lTop = std::min(router_cfg_->TOP_ROUTING_LAYER, getTech()->getTopLayerNum());
  frLayerNum lBot = std::max(router_cfg_->BOTTOM_ROUTING_LAYER, getTech()->getBottomLayerNum());
